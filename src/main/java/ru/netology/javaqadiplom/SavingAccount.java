...
public class SavingAccount extends Account {
    ...
    public SavingAccount(int initialBalance, int minBalance, int maxBalance, int rate) {
        ...
        if (initialBalance > maxBalance) {
            throw new IllegalArgumentException(
                    "Начальный баланс не может быть больше максимального баланса, а у вас начальный баланс: " + initialBalance +
                            ", а максиимальный баланс: " + maxBalance
            );
        }
        if (minBalance > maxBalance) {
            throw new IllegalArgumentException(
                    "Минимальный баланс не может быть больше максимального баланса, а у вас минимальный баланс: " + minBalance +
                            ", а максиимальный баланс: " + maxBalance
            );
        }
        if (minBalance < 0) {
            throw new IllegalArgumentException(
                    "Минимальный баланс не может быть отрицательным, а у вас минимальный баланс: " + minBalance
            );
        }
        if (maxBalance < 0) {
            throw new IllegalArgumentException(
                    "Максимальный баланс не может быть отрицательным, а у вас максимальный баланс: " + maxBalance
            );
        }
        if (initialBalance < 0) {
            throw new IllegalArgumentException(
                    "Начальный баланс не может быть отрицательным, а у вас начальный баланс: " + initialBalance
            );
        }
